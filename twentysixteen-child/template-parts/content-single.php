...
if( have_rows('content') ):
    while ( have_rows('content') ) : the_row();
        if( get_row_layout() == 'een_kolom' ):
			...
			echo "<div class='dranger'>"; if( get_sub_field('achtergrond') ): echo "<div class='achtergrond'><img src='".get_sub_field('achtergrond')."'></div>"; endif; echo "<div class='rij kolom1 rkop'>";
				echo $field1;
			echo "</div></div>";	
        elseif( get_row_layout() == 'kop' ):
            $field1 = get_sub_field('kop');
			echo "<div class='dranger'>"; if( get_sub_field('achtergrond') ): echo "<div class='achtergrond'><img src='".get_sub_field('achtergrond')."'></div>"; endif; echo "<div class='rij kolom1 rkop'><h2>";
				echo $field1;
			echo "</h2></div></div>";	
				...
				if ($field2=="") { $field2=0; }
					...
					if ($pusts->have_posts()){
    					while ($pusts->have_posts()){
							...
							if( $field3 ): 
								foreach( $field3 as $element ): 
									if ($element=="titel") { echo "<h6>".get_the_title()."</h6>"; }
